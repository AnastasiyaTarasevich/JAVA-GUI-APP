...
public class DelPosController {
    ...
    @FXML
    private Button enterDelPos_button;
    ...
    void initialize() {
        ...
        enterDelPos_button.addEventHandler(MouseEvent.MOUSE_CLICKED,mouseEvent ->
        {
            ...
            if(en.equals("alive"))
            {
                ...
                alert.showAndWait();
                Stage stage =  (Stage) enterDelPos_button.getScene().getWindow();
                stage.close();
                Parent root = null;
                try {
                    root = FXMLLoader.load((getClass().getResource("admin-menu.fxml")));
