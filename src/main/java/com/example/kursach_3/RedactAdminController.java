...
public class RedactAdminController {
    ...
    @FXML
    private Button enterRedactAdmin_button;
    ...
    void initialize() {
        ...
        enterRedactAdmin_button.addEventHandler(MouseEvent.MOUSE_CLICKED, mouseEvent-> {
                    ...
                    if(en.equals("alive"))
                    {
                        ...
                        Stage stage =  (Stage) enterRedactAdmin_button.getScene().getWindow();
                        Parent root = null;
                        try {
