...
public class DelUserController {
    ...
    @FXML
    private Button enterDelUser_button;
    ...
    void initialize() {
        ...
        enterDelUser_button.addEventHandler(MouseEvent.MOUSE_CLICKED, mouseEvent ->
        {
            ...
            if(en.equals("alive"))
            {
                ...
                alert.showAndWait();
                Stage stage =  (Stage) enterDelUser_button.getScene().getWindow();
                stage.close();
                Parent root = null;
                try {
                    root = FXMLLoader.load((getClass().getResource("admin-menu.fxml")));
